...
I turn messy data into decisions that optimize revenue and combat risk. I started in a microbiology lab analyzing pathogens — today I analyze business data with the same rigor: ask the right question, trust the evidence, find the answer.
...
![Docker](https://img.shields.io/badge/Render-46E3B7?style=flat&logo=render&logoColor=white)

Also working with: Decision Trees · RandomForest · SMOTE · SHAP · EDA · Feature Engineering · Statistical Modeling · A/B Testing · Time Series (ARIMA, Prophet) · Model Monitoring & Logging · Railway · Vercel
